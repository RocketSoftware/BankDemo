      ...
      *****************************************************************
      * CBANKX05.CPY (CICS Version)                                   *
      *---------------------------------------------------------------*
      * This copybook is used to provide an common means of calling   *
      * data access module DBANK05P so that the that module using     *
      ...
      * by default use CICS commands to call the module
           EXEC CICS LINK PROGRAM('DBANK05P')
                          COMMAREA(CD05-DATA)
                          LENGTH(LENGTH OF CD05-DATA)
           END-EXEC
      *    CALL 'DBANK05P' USING CD05-DATA
