      ...
      *****************************************************************
      * CBANKX09.CPY (CICS Version)                                   *
      *---------------------------------------------------------------*
      * This copybook is used to provide an common means of calling   *
      * data access module DBANK09P so that the that module using     *
      ...
      * by default use CICS commands to call the module
           EXEC CICS LINK PROGRAM('DBANK09P')
                          COMMAREA(CD09-DATA)
                          LENGTH(LENGTH OF CD09-DATA)
           END-EXEC
      *    CALL 'DBANK09P' USING CD09-DATA
