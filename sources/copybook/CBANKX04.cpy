      ...
      *****************************************************************
      * CBANKX04.CPY (CICS Version)                                   *
      *---------------------------------------------------------------*
      * This copybook is used to provide an common means of calling   *
      * data access module DBANK04P so that the that module using     *
      ...
      * by default use CICS commands to call the module
           EXEC CICS LINK PROGRAM('DBANK04P')
                          COMMAREA(CD04-DATA)
                          LENGTH(LENGTH OF CD04-DATA)
           END-EXEC
      *    CALL 'DBANK04P' USING CD04-DATA
