      ...
      *****************************************************************
      * CBANKX06.CPY (CICS Version)                                   *
      *---------------------------------------------------------------*
      * This copybook is used to provide an common means of calling   *
      * data access module DBANK06P so that the that module using     *
      ...
      * by default use CICS commands to call the module
           EXEC CICS LINK PROGRAM('DBANK06P')
                          COMMAREA(CD06-DATA)
                          LENGTH(LENGTH OF CD06-DATA)
           END-EXEC
      *    CALL 'DBANK06P' USING CD06-DATA
